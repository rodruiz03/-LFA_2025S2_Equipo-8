...
#funcion principal por el espacio
if __name__ == "__main__":
    main()

#acordarte de hacer las preguntas a la ingeniera y tambien preguntar dentro de la docuemntacion que lleva el manual de usuario y el manual tecnico
